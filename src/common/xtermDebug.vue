...
export default {
  ...
  methods: {
    ...
    initTerm () {
      ...
      const url = `/api/podexec/${this.envName}/${this.projectName}/${this.namespace}/${this.podName}/${this.containerName}/podExec?projectName=${this.projectName}&clusterId=${this.clusterId}&token=${token}`
