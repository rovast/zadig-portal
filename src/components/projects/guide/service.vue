...
import addCode from '../service_mgr/common/integrationCode.vue'
import serviceAsideK8s from '../service_mgr/k8s/serviceAside.vue'
import serviceEditorK8s from './k8s/container/service_editor.vue'
import serviceTree from '../service_mgr/common/serviceTree.vue'
